...
| `starovek.json` + `static/starovek/<id>/` | stránky o civilizacích starověku (Sumer a Akkad, Egypt, Elam a Urartu, Indie, Chetité, Čína, Féničané, Hebrejci a Aramejci, Řecko, Keltové, Etruskové, Persie, Řím, Arméni a Gruzínci, Germáni, Aksum, Turkuti a orchonské písmo, Slované, Mayové, Aztékové; přehledy Rodokmen písem a Slovníček pojmů) a Příběhy jazyků (sekce `pribehy`: Čaj a slova na cestách, Slova z češtiny ve světě, Jak z latiny vznikly románské jazyky, Jazyky, které se vracejí, Jazykové záhady): texty, ukázky znaků, časová osa, fotografie | texty vlastní práce podle literatury uvedené na stránce, ověřené proti odborným zdrojům; fotografie z [Wikimedia Commons](https://commons.wikimedia.org) (stahuje `scripts/fotky.mjs` v GitHub Actions, u každé autor, licence a odkaz); ilustrace vlastní (`src/akvarely.js`, druhy `mezopotamie`, `egypt`, `chattusa`, `fenicie`, `akropole`, `maya`, `forum`, `etrurie`, `sang`, `sanci`, `persepolis`, `aksum`, `pisarna`, `oppidum`, `runy`, `hradiste`, `kumran`, `klaster`, `cogazanbil`, `orchon`, `tenochtitlan`, `cajovnik`, `jachymov`, `via`, `obnova`, `zahada`); písma [Noto Sans Cuneiform, Anatolian Hieroglyphs, Egyptian Hieroglyphs, Coptic, Phoenician, Ugaritic, Linear B, Mayan Numerals, Old Italic, Brahmi, Kharoshthi, Old Persian, Avestan, Inscriptional Pahlavi, Imperial Aramaic, Old South Arabian, Serif Devanagari, Serif Ethiopic, Serif TC, Runic, Old Turkic, Gothic, Ogham, Glagolitic, Serif Hebrew, Syriac, Nabataean, Palmyrene, Samaritan, Naskh Arabic, Serif Armenian, Serif Georgian, Serif Tibetan a Serif Tamil](https://fonts.google.com/noto) | texty a ilustrace atlasu; fotky CC BY / CC BY-SA / CC0 / volné dílo – **uvedení autora a licence je povinné**, proto je u každé fotky; písma SIL OFL |
| `cesty-slov.json` | cesty slov na glóbu (čaj, káva, cukr, pomeranč, robot, dolar): z kterého jazyka do kterého slovo přešlo, tvar, doba, sporné kroky | vlastní zpracování podle ověřených stránek Čaj a slova na cestách a Slova z češtiny ve světě a etymologických slovníků (Kluge/DWDS, OED, Rejzek, Machek; české káva podle V. Poláka, Naše řeč 20, 1936); nezávisle ověřeno | texty atlasu |
