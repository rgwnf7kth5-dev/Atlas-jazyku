...
// Společné soubory (skript, malby, ikony, náhledy, fotky stránek o civilizacích v /starovek/) leží v kořeni dist/
...
const SPOLECNE = /^\/(js|malby|starovek)\/|^\/(favicon\.svg|apple-touch-icon\.png|nahled-[^/]*\.jpg|_headers)$/;
...
export const config = { path: "/*", excludedPath: ["/en/*", "/js/*", "/malby/*", "/starovek/*"] };
